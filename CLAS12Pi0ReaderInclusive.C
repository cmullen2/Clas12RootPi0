...
void CLAS12Pi0ReaderInclusive(){
  ...
  /////////////////////////////////////
  //  TString outputFile;
//  TFile *outputFile = new TFile("/project/Gruppo3/fiber7/cmullen/outputpass0/InclusiveComparisonOfDeltaTimesFTShifted25.root","recreate");
//  TFile *outputFile = new TFile("/project/Gruppo3/fiber7/cmullen/outputpass0/InclusiveAll65Files.root","recreate");
  TFile *outputFile = new TFile("/project/Gruppo3/fiber7/cmullen/outputpass0/InclusiveCompareToPass1InitialFiles3rdMarch2020V2.root","recreate");
//  TFile *outputFile = new TFile("/project/Gruppo3/fiber7/cmullen/outputpass1Initial/InclusiveAll9InitalFiles2ndMarch2020.root","recreate");
  /////////////////////////////////////
...
//  chain.Add("/project/Gruppo3/fiber7/cmullen/pass1Initial/skim2_*");
  ...
  for(Int_t i=0;i<files->GetEntries();i++){
	...
	//Discrim Vars
	TLorentzVector miss=beam+target-el-g1-g2;
	MissMass2 = miss.M2();
	MissMass = miss.M();
	MissMom = miss.P();
	MissEnergy = miss.E();
	...
	Coplanarity = (ROOT::Math::VectorUtil::DeltaPhi(pi0, -(ReconProton) ) )*TMath::RadToDeg();
...
//	MissMassEP2 = missEP.M2();
	...
	fBar=HSLorentzVector(ReconProton.X(),ReconProton.Y(),ReconProton.Z(),ReconProton.T());
